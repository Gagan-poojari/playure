    ...
    return (
        <div className="flex-1 bg-gradient-to-br from-gray-50 to-white p-8 overflow-y-auto">
            <div className="max-w-2xl mx-auto">
                ...
                {/* Elegant Share Box */}
                <div className="bg-white p-4 rounded-3xl shadow-lg shadow-gray-900/5 border border-gray-100 mb-8 ">
                    <div className="flex w-full justify-center items-end gap-2 mb-4">
    <span className="text-gray-500 text-xl">Welcome back,</span>
    <span className="text-2xl font-extrabold bg-gradient-to-r from-blue-600 via-indigo-500 to-purple-600 bg-clip-text text-transparent">
